...
BUILDFLAGS ?= \
	...
	--build-arg GLIBCARCH=$(call get_apkbuild_arch) \
	...
	--rm \
	--tag $(IMAGETAG) \
	# --build-arg COMPILERIMAGE=ubuntu:latest \
	#
...
$(shell \
	...
	OFILE=$(CURDIR)/$(if $(1),$(1),GLIBCVERSION);
	if [ ! -f $${OFILE} ] \
...
APKBUILD_ARCH_MAP := \
	...
	'armv7l'  ) echo -n 'armv7'      ;; \
	'i386'    ) echo -n 'x86'        ;; \
	'loong64' ) echo -n 'loongarch64';; \
	'ppc64le' ) echo -n 'ppc64le'    ;; \
	'riscv64' ) echo -n 'riscv64'    ;; \
	's390x'   ) echo -n 's390x'      ;; \
	'x86_64'  ) echo -n 'x86_64'     ;; \
    #
define get_apkbuild_arch
$(shell case "$(ARCH)" in $(APKBUILD_ARCH_MAP) esac)
endef
# -- }}}
